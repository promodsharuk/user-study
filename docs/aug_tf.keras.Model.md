...
<span id="target"></span>
**Issue:** How to use the `tf.keras.Model.fit` function with a `tf.data.Dataset`
...
### Code Example
This example demonstrates how to properly use the `tf.data.Dataset` API with the `tf.keras.Model.fit` function.
...
y_val = np.random.randint(10, size=(200, 1))

# Convert the numpy arrays to tf.data.Dataset
train_dataset = tf.data.Dataset.from_tensor_slices((x_train, y_train))
val_dataset = tf.data.Dataset.from_tensor_slices((x_val, y_val))

# Apply shuffle, batch, and repeat operations
batch_size = 32
epochs = 10
...
- <a href="https://stackoverflow.com/questions/50184144/shuffle-in-the-model-fit-of-keras" target="_blank">shuffle in the model.fit of keras</a>

- <a href="https://stackoverflow.com/questions/64356209/how-does-model-fit-methods-shuffle-deals-with-batches-when-using-a-tf-data-da" target="_blank">How does Model.fit() method's shuffle deals with Batches when using a tf.data.Dataset?</a>

- <a href="https://stackoverflow.com/questions/50955798/keras-model-fit-with-tf-dataset-api-validation-data" target="_blank">Keras model.fit() with tf.dataset API + validation_data</a>

### Related YouTube Tutorials
Video tutorials to learn concepts related to the [**issue**](#target) with this API.
- <a href="https://www.youtube.com/watch?v=S6tLSI8bjGs" target="_blank">TensorFlow Tutorial 15 - Customizing Model.Fit</a>
